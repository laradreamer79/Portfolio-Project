...
| Project Name | Overview | Problem Addressed | Target Audience | Key Features |
|-------------|----------|------------------|----------------|--------------|
| **Murshid** | Smart airport navigation platform that guides travelers from airport entry to their boarding gate in real time. | Large airports can be confusing and stressful, especially without accurate indoor navigation and real-time service information. | Frequent travelers, first-time international travelers, elderly passengers, families. | Real-time indoor navigation, shop directory, product search, airport service information. |
| **Baseer** | AI-powered accessibility assistant for visually impaired users using computer vision and smart guidance. | Visually impaired individuals face challenges identifying surroundings and navigating unfamiliar environments independently. | Blind or partially visually impaired individuals, educational and accessibility support institutions. | Object recognition, voice guidance, haptic feedback navigation, obstacle detection. |
| **Mihan** | Digital marketplace connecting service providers and skilled workers with customers. | Service providers struggle to reach customers, while users struggle to find trusted and suitable service providers. | Skilled workers, freelancers, small business owners, customers seeking services. | Service listings, smart search and filtering, ratings and reviews, profile pages. |
| **Qareeb** | Community-based platform connecting nearby users to help complete small daily tasks quickly. | People often need quick assistance with errands, deliveries, or daily tasks, but lack an organized local support platform. | Neighborhood residents, users seeking quick help, individuals seeking extra income. | Task posting, nearby offers, status tracking, offer comparison, location-based matching. |
| **Oyster** | Diving platform that connects users with diving centers, instructors, courses, and diving experiences across Saudi Arabia. | Divers struggle to find trusted diving centers, compare experiences, pricing, and training options in one unified platform. | Diving enthusiasts, tourists, beginners, professional divers, diving centers, instructors. | Dive center listings, booking system, instructor registration, reviews, interactive dive map, training courses. |
